              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3 px-2 d-flex flex-row justify-content-end">
                    ...
                    <div>
                        ...
                        <button type="button" onclick="checkEmail()" class="d-sm-inline-block btn btn-primary shadow-sm" name="check_email" id="check_email">
                        ...
                        <div id="products_container">
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="quantity[]" id="quantity_1" class="form-control quantity_change" value=0>
                                </div>
                            </div>
                            <!-- END: Quantity -->
                            <!-- BEGIN: Discount -->
                            <div class="col-md-1">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="discount[]" id="discount_1" class="form-control discount_change" value=0>
                                </div>
                            </div>
                            <!-- END: Discount -->
                            <!-- BEGIN: Total Price -->
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="total_price_1" class="form-control" disabled value = 0>
                                </div>
                            </div>
                            <!-- END:  Total Price -->
                        ...
                        <div class="row payments">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="payment_method" id="payment_method" class="form-control payment_select">
